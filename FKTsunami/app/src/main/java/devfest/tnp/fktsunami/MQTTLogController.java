//package com.terra.drone.features.flight.fly.realtime.mqtt;
//
...
////import com.terra.drone.BuildConfig;
////import com.terra.drone.app.DroneApplication;
////import com.terra.drone.common.utils.Utils;
////import com.terra.drone.devices.Drone;
////import com.terra.drone.devices.models.DroneAttribute;
////import com.terra.drone.features.flight.fly.models.FlyingDroneLog;
////import com.terra.drone.features.flight.fly.models.RealtimeWeatherInfo;
////import com.terra.drone.features.flight.fly.realtime.LogController;
////import com.terra.drone.features.flight.fly.realtime.OnRealTimeListener;
////import com.terra.drone.features.flight.fly.realtime.RealTimeEvent;
////import com.terra.drone.features.flight.fly.realtime.RemoteDroneAction;
////import com.terra.drone.manager.PreferenceManager;
//
...
// */
//
//public class MqttLogController implements LogController, MqttListener, Drone.OnDroneAttributeChanged {
//
...
//        mAwsMqttClient = new AwsMqttClient(BuildConfig.CUSTOMER_SPECIFIC_ENDPOINT, BuildConfig.COGNITO_POOL_ID, BuildConfig.MY_REGION);
